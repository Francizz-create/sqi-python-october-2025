...
# and are on the confirmed_guests list. The confirmed_guests list is full. New guests who accept the invitation will be waitlisted.
...
# Step4
# Alice has a family emergency and won’t be able to attend the wedding, She cancels her attendance. Remove Alice 
# from the confirmed guest list and add the first person from the waitlist to the confirmed list.
...
print("Waitlist: ", waitlist)
# Step5
# Charlie is the godfather of the groom and he is the one funding the wedding. Therefore he is a VIP guest and the couple has asked you to make sure he 
...
# Step10
# The bride and groom have decided that they want to allow room for 5 more people to attend their wedding. 
# Move waitlisted guest (Noah) into the confirmed_guests list.
confirmed_guests.append(waitlist.pop(0))
print("\n\nStage 10")
print("Confirmed guests: ", confirmed_guests)
print("Waitlist: ", waitlist)
...
# Step13
# A new guest called Collins who is the son of Grace and Noah would be attending on their behalf,
#  Replace Grace and Noah on the confirmed_guests list with Collins. Make sure you re-sort the list.
...
# Step15
# The deadline for accepting the invitations sent has now passed. There is no more need for the waitlist. 
# Clear the waitlist.
